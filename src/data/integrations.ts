...
export const INTEGRATIONS: IntegrationDef[] = [
  ...
  },
  {
    ...
    category: 'Pagos',
    icon: '🛒',
    description: 'Enlace a tu cuenta MP para cobrar fuera de IA·RESTAURANT. El dinero va directo a Mercado Pago.',
  ...
  {
    id: 'stripe',
    name: 'Stripe (restaurante)',
    category: 'Pagos',
    icon: '💳',
    description: 'Enlace a Stripe de tu negocio para cobrar fuera de la app. Distinto del Stripe de tu plan IA·RESTAURANT.',
  ...
  },
  {
    ...
    category: 'Pagos',
    icon: '📱',
    description: 'Enlace a Clip para terminal y cobro presencial fuera de IA·RESTAURANT.',
