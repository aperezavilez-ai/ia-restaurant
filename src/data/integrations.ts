...
export const INTEGRATIONS: IntegrationDef[] = [
  ...
  },
  {
    ...
    category: 'Delivery',
    icon: '🛵',
    description: 'Gestiona pedidos a domicilio manualmente. La conexión API automática llegará pronto.',
    path: '/app/delivery',
    status: 'coming_soon',
    statusLabel: 'Pedidos manuales',
  },
  {
    id: 'rappi',
    name: 'Rappi',
    category: 'Delivery',
    icon: '🏍️',
    description: 'Registra y da seguimiento a pedidos externos desde el módulo Delivery.',
    path: '/app/delivery',
    status: 'coming_soon',
    statusLabel: 'Pedidos manuales',
  },
